...
//            curl_setopt($this->ch, CURLOPT_HEADER, true);
            ...
            switch ($action->getType()) {
                ...
                default:
                    throw new \Exception(__("Invalid HTTP Method", LOBBY_CHATWING_TEXTDOMAIN), 1);
                    break;
            }
...
//            $header = substr($result, 0, $header_size);
            ...
            if (!$result) {
                throw new \Exception(__("Invalid response", LOBBY_CHATWING_TEXTDOMAIN), $responseStatus);
            }
